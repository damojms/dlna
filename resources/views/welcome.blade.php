      ...
      <div class="main">  
                     ...
                     <h3>Menu Box</h3>
                       <div class="menu_box_list">
                            ...
                            @foreach($objects as $object)
                                <li><a href="" class="messages" description="{{ substr($object->NAME,10) }}"><span>{{ $object->NAME }}</span></a></li>
                            @endforeach
        ...
        <div class="clear"></div>
         ...
         <div class="copy-right">
                <p>Â© 2013 Designed by <a href="http://graphicburger.com/flat-design-ui-components/" target="_blank">GraphicBurger</a>  â€¢ Template by <a href="http://w3layouts.com" target="_blank">w3layouts</a> </p>
         </div>   
</body>
</html>